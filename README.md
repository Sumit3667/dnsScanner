...
3. Click on the appropriate file for your system:
   - If you prefer using **Bash**, click on the link for the Bash version.
   - If you prefer using **Python** with a user interface, choose the link for the Python version.
...
## 📈 Features
- **Fast Scanning:** Quickly scan millions of IP addresses to find DNS.
- **Export Results:** Save results in a text file for future reference.
- **User-Friendly Interface:** Easy navigation for all users, regardless of technical skill.

## 📄 Usage Instructions
1. Launch the application using the methods described above.
2. Follow the prompts:
   - For Bash, you will enter commands directly into the terminal.
   - For Python, simply click buttons on the UI.
